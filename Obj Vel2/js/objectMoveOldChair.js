...
function onKeyPress(e) {
    ...
    */
    ...
    /*
    case 37: //left
        chair.userData.moving.x = true;
        if (chair.userData.speed.x > -0.4) {
            chair.userData.speed.x -= 0.06;
        }
        break;
    case 39: //right
        chair.userData.moving.x = true;
    ...
    case 38: //up
        chair.userData.moving.z = true;
        if (chair.userData.speed.z > -0.4) {
...
function animate() {
    ...
    if (chair.userData.moveKeys.right) {
        chair.userData.speed.x += 0.03;
    }
    if (chair.userData.moveKeys.left) {
        chair.userData.speed.x -= 0.03;
    }
    if (chair.userData.moveKeys.up) {
        chair.userData.speed.z -= 0.03;
    }
    if (chair.userData.moveKeys.down) {
        chair.userData.speed.z += 0.03;
    }
    ...
    /*chair.userData.step += 0.04;
    chair.position.y = Math.abs(30 * (Math.sin(chair.userData.step)));
    chair.position.z = 15 * (Math.cos(chair.userData.step));
    */
